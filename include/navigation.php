            ...
            <ul class="nav navbar-nav navbar-right">
                <?php
                    ...
                    else if (isset($_SESSION['FirstName']) && ($_SESSION['Role'] == "Member"))
                    {
                        ...
                        <li class="<?php if ($page_title == 'Profile') echo 'active' ?>"><a href="profile.php">Profile</a></li>
                    ...
                    else if (isset($_SESSION['FirstName']) && ($_SESSION['Role'] == "Admin"))
                    {
                        ...
                        <li class="<?php if ($page_title == 'Admin Panel') echo 'active' ?>"><a href="adminPanel.php">Admin Panel</a></li>
                        <li class="<?php if ($page_title == 'Profile') echo 'active' ?>"><a href="profile.php">Profile</a></li>
                        <li><a href="php/logout.php">Logout</a></li>
                        <?php
                    }
